...
HOW TO DOWNLOAD:  Either you can run the already compiled version (the ".jar" file) or you can run "javac Main.java" and then "java Main" (minus the quotation marks)
